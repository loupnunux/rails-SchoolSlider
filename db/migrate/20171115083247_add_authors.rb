class AddAuthors < ActiveRecord::Migration[5.1]
  def change
    ...
    Author.create :name => "Alexandros d'Antioche", :birth => '130 av. J.C.', :death => '100 av. J.C.'
    Author.create :name => "Hokusai", :birth => '1760', :death => '1849'
    Author.create :name => "Auguste Rodin", :birth => '1840', :death => '1917'
  end
end
