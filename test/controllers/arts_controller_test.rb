...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { author_id: @art.author_id, titre: @art.titre, typeart: @art.typeart } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { author_id: @art.author_id, titre: @art.titre, typeart: @art.typeart } }
