...
class SlidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post slides_url, params: { slide: { comment: @slide.comment, end: @slide.end, name: @slide.name, start: @slide.start } }
    end
  ...
  test "should update slide" do
    patch slide_url(@slide), params: { slide: { comment: @slide.comment, end: @slide.end, name: @slide.name, start: @slide.start } }
